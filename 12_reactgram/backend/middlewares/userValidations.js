...
const userCreateValidations = () => {
  return [
    ...
    body("email").isString().withMessage("O e-mail é obrigatório.").isEmail().withMessage("Precisa ser um e-mail válido"),
    ...
    body("confirmPassword").isString().withMessage('Confirmar senha é obrigatória').isLength({min: 5}).withMessage("A senha precisa ter no mínimo 5 caracteres.").custom((value, {req}) => {
